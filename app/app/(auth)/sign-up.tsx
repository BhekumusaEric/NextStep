...
const styles = StyleSheet.create({
  ...
  top: { marginBottom: 40 },
  title: { fontSize: 32, fontFamily: 'Sora_700Bold', color: Colors.textPrimary, letterSpacing: -0.5 },
  subtitle: { fontSize: 15, fontFamily: 'Inter_400Regular', color: Colors.textMuted, marginTop: 6 },
  form: { gap: 4 },
